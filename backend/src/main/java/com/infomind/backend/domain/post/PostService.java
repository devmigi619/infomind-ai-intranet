...
public class PostService {
    ...
    @Transactional
    public PostController.PostDetailDto createPost(String authorId, PostController.PostRequest request) {
    ...
    @Transactional
    public PostController.PostDetailDto updatePost(Long postId, String userId, PostController.PostRequest request) {
    ...
    public void deletePost(Long postId, String userId, String userRole) {
        ...
        if (!post.getAuthor().getUserId().equals(userId) && !isAdmin) {
    ...
    private PostController.PostSummaryDto toSummary(Post post) {
        return PostController.PostSummaryDto.builder()
                .id(post.getId())
                .title(post.getTitle())
                .authorName(post.getAuthor().getUserNm())
                .category(post.getCategory().name())
                .viewCount(post.getViewCount())
                .createdAt(post.getCrtAt())
                .build();
    }
